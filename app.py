...
class ResumeApp:
    ...
    st.session_state.form_data['skills_categories']['tools']),
        ...
        if st.button("Generate Resume 📄", type="primary"):
            ...
            print(f"Email input value: {st.session_state.get('email')}")
            # ...existing code...
        
            def render_home(self):
                apply_modern_styles()
                
                # Minimalistic Hero Section with centered layout and subtle animation
                st.markdown("""
                <style>
                .minimal-hero {
                    text-align: center;
                ...
                @media (max-width: 768px) {
                    ...
                    .minimal-features { flex-direction: column; align-items: center; }
                    .minimal-feature { max-width: 100%; }
                }
                </style>
                """, unsafe_allow_html=True)
                ...
                # Minimalistic Features Section with fewer, cleaner cards
                st.markdown("""
                <div class="minimal-features">
                    <div class="minimal-feature">
                        <i class="fas fa-robot"></i>
                        <h3>AI Analysis</h3>
                        <p>Instant feedback on your resume with advanced AI</p>
                    </div>
                    <div class="minimal-feature">
                ...
                st.markdown('<div class="minimal-cta">', unsafe_allow_html=True)
